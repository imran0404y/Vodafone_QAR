...
public class Keyword_CRM extends Driver {
		...
		try {
			...
			if (Exi.equals("")) {
				...
				if (!(getdata("Cont_MobilePhone").equals(""))) {
					...
					Browser.WebTable.SetDataE("Acc_Contact", Row, Col, "Cellular_Phone__",
							pulldata("Cont_MobilePhone"));
				}
				...
				if (!(getdata("Cont_PrefLang").equals(""))) {
					Browser.WebTable.SetData("Acc_Contact", Row, Col, "VFQ_Preferred_Language",
							getdata("Cont_PrefLang"));
				} else {
					Browser.WebTable.SetData("Acc_Contact", Row, Col, "VFQ_Preferred_Language",
							pulldata("Cont_PrefLang"));
				}
	...
	public String Consumer_Migration() {
		...
		try {
			...
			Col_Pro = CO.Select_Cell("Installed_Assert", "Asset Description");
			...
			for (int i = 1; i <= Inst_RowCount; i++)
				if (Browser.WebTable.getCellData("Installed_Assert", i, Col).equals(MSISDN)
						&& Browser.WebTable.getCellData("Installed_Assert", i, Col_Pro).equals(GetData)) {
